...
<div class="content-wrapper">
  ...
  <section class="content">
      ...
      <tr>
        ...
        echo "<td>".penulis($row['user_id'])."</td>";
        echo "<td>".kategori($row['kategori_id'])."</td>";
        echo "<td>".status($row['status'])."</td>";
        echo "<td>".date('d F Y', strtotime($row['rilis']))."</td>";
        ?>
        <td>
          <a href="http://localhost/adminlte/admin/artikel/edit.php?id=<?= $row['id'] ?>" class="btn btn-primary btn-xs">edit</a>
          <a href="http://localhost/adminlte/admin/artikel/hapus.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-xs">hapus</a>
        </td>
      </tr>
      <?php
        }
